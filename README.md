...
正文中注明的参考代码行对应的代码文件请参阅 [xv6-src-booklet-rev5.pdf][4]。本仓库也下载了一份 [pdf](./xv6-src-booklet-rev5.pdf)。

本文对应的 [xv6-riscv 代码仓库][2] 4f1bdde "try again to fix the dirent name strncpy warning"。
